...
class Amp < Formula
  ...
  on_linux do
    if Hardware::CPU.arm?
      url 'https://github.com/sourcegraph/amp-cli/releases/download/v1.0.0/amp-linux-arm64'
      sha256 'REPLACE_WITH_LINUX_ARM64_SHA256'
    else
      url 'https://github.com/sourcegraph/amp-cli/releases/download/v1.0.0/amp-linux-x64'
