...
class Amp < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      url 'https://packages.ampcode.com/binaries/v0.0.1754035600/amp-darwin-x64'
  ...
  on_linux do
    if Hardware::CPU.arm?
      url 'https://packages.ampcode.com/binaries/v0.0.1754035600/amp-linux-arm64'
      sha256 '6bb51ffb56e7aa078932f65d4e9b419102c726caf098ffc1aa924af7595e36bd'
    else
      url 'https://packages.ampcode.com/binaries/v0.0.1754035600/amp-linux-x64'
