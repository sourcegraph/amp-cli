...
class Amp < Formula
  ...
  url 'https://packages.ampcode.com/binaries/cli/v0.0.1754050083/amp-darwin-arm64'
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      url 'https://packages.ampcode.com/binaries/cli/v0.0.1754050083/amp-darwin-x64'
  ...
  on_linux do
    if Hardware::CPU.arm?
      url 'https://packages.ampcode.com/binaries/cli/v0.0.1754050083/amp-linux-arm64'
      sha256 '167e5ebaace8e6d57175240cd387c2222d947339f9f74c9855bfc38f8ff109e5'
    else
      url 'https://packages.ampcode.com/binaries/cli/v0.0.1754050083/amp-linux-x64'
