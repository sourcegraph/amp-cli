...
# Usage: curl -fsSL https://raw.githubusercontent.com/sourcegraph/amp-packages/main/install.sh | bash
...
install_deb() {
    ...
    if command_exists curl; then
        ...
        wget -qO- https://github.com/sourcegraph/amp-packages/releases/download/gpg/amp-cli.asc | sudo gpg --dearmor -o /usr/share/keyrings/amp-cli.gpg
    else
...
install_deb_direct() {
    ...
    local deb_url="https://github.com/sourcegraph/amp-packages/releases/download/v${VERSION}/amp_${VERSION}-1_${ARCH}.deb"
...
install_rpm_direct() {
    ...
    local rpm_url="https://github.com/sourcegraph/amp-packages/releases/download/v${VERSION}/amp-${VERSION}-1.${rpm_arch}.rpm"
...
install_manual() {
    ...
    local binary_url="https://github.com/sourcegraph/amp-packages/releases/download/v${VERSION}/amp-${OS}-${ARCH}"
